...
parser.add_argument('--use-selection', action='store_true', default=True,
                    help='Use NVIDIA Apex AMP mixed precision')
parser.add_argument('--use-combiner', action='store_true', default=True,
                    help='Use NVIDIA Apex AMP mixed precision')
parser.add_argument('--fpn-size', type=int, default=1536,
                    help='Number classes in dataset')
parser.add_argument('--num-selects', type=dict, default={'layer1': 2048,'layer2': 512,'layer3': 128,'layer4': 32},
                    help='Number classes in dataset')
